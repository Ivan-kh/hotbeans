...
function ValidateVacancyForm() {
    ...
    // Check the email if it's not empty
    if (document.forms["VacancyApplicationForm"]["ename"].value == "") {
        document.getElementById("eNameError").innerHTML = "Please Enter your email address";
        flag5 = false;
    } else {
        // Clear the previous error
        document.getElementById("eNameError").innerHTML = "";
        var email = document.forms["VacancyApplicationForm"]["ename"].value;

        // Check if email ends with "@gmail.com"
        if (!email.toLowerCase().endsWith("@gmail.com")) {
            document.getElementById("eNameError").innerHTML = "Please enter a valid Gmail address";
            flag5 = false;
        } else {
            // Email is valid
            flag5 = true;
